...
public class SignUpPage {
    ...
    public void display(Pane pane, Button loginButton, Button signUpButton , Rectangle loginRectangle, Label welcome, Label msg,LoginPage loginPage) {
        ...
        loginButton.setOnAction(_ -> {
            ...
            // هنا نقوم بإعادة إنشاء واجهة تسجيل الدخول
